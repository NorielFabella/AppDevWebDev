...
<body>
    ...
    <div class = "container-fluid">
        <ul class = "pager">
            <li class = "previous"><a href = "#"> Previous </li>
            <li class = "next"><a href = "#"> Next </li>
        </ul>
        ...
        <div class = "panel-group" id = "myaccordion">
            ...
            <div class = "panel panel-danger">
                ...
                <div class = "collapse panel-collapse" id = "colap2">
                    <div class = "panel-body"><img src = "pic/Kirby Knife 2.png"></div>
                </div>
            </div>
                ...
                <div class = "panel panel-default">
                    ...
                    <div class = "collapse panel-collapse" id = "efg">
                        <ul class = "list-group">
                            ...
                            <li class = "list-group-item"> CES </li>
    ...
    <div class = "panel panel-success">
                ...
                <div class = "panel-body">
                    <p>This is panel body</p>
                </div>
                <div class = "panel-footer"><p>This is panel-footer</p> </div>
        ...
        <button class = "btn btn-primary" data-target = "#dtx" data-toggle = "collapse">Click to Collapse</button>
            ...
            <div id = "dtx" class = "collapse"><img src = "pic/Kirby Knife 2.png"></div>
